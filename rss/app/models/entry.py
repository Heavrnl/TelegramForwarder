...
class Media(BaseModel):
    ...
    def get(self, key: str, default: Any = None) -> Any:
        """Get attribute value, return default if it does not exist"""
...
class Entry(BaseModel):
    ...
    link: str = ""
    media: List[Media] = []
    created_at: Optional[str] = None  # Time added to the system
    original_link: Optional[str] = None
    sender_info: Optional[str] = None


    def __init__(self, **data):
        # Process media data, ensure it is a list of Media objects
